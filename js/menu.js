  ...
  $("#st-search-input").on('keyup change', function(e) {
    ...
    if (lastSearch != searchVal)
    {
      ...
      if (results.length > 0)
      {
        ...
        resultsOutput.push("<div id='autocompleteShowAll'><ul class='autocompleteList'>{% if site.docs==true %}<li class='autocompleteTitle' id='autoSeeAll'><a href='/search/?q=" + searchVal + "'><b>Showing top " + resultsShownText + ". See all results...</b></a></li>{% endif %}</ul></div>")
        resultsOutput.push("</div>");
